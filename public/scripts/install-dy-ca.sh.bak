...
# ================================
# DYZULK CA INSTALLER
# Target : Ubuntu 20.04+ / 22.04 / 24.04 (LXC / VM / Baremetal)
# Author : dyzulk.com
# ================================
...
# Gabungkan full chain (best practice)
echo "[INFO] Membuat full chain CA..."
cat "$ROOT_CA_FILE" "$INT_CA_FILE" > "$FULL_CHAIN_FILE"
...
echo "[INFO] CA kini dipercaya oleh sistem (curl, apt, git, openssl)."
